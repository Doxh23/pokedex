...
const Moves = (prop) => {
  ...
  return (
    ...
    <td className={`py-[3px] px-[2px] font-semibold`} style={{background: bgcolor}}>{move?.name}</td>
    ...
    <td className='font-semibold' style={{background: bgcolor,color: textColor}}> {move && move?.effect_entries[0]?.effect}</td>
       </> 
